...
const TOAST_COPY: Record<
  ToastIntent,
  { title: string; description: string; variant: ToastProps['variant'] }
> = {
  success: {
    title: 'Success',
  ...
  info: {
    title: 'FYI',
    description: "Here's the latest update.",
    variant: 'default',
  },
  warning: {
    title: 'Please check',
    description: 'We need your attention before proceeding.',
    variant: 'default',
  },
};
...
export { useToast, toast, showToast, TOAST_COPY };
export type { ToastIntent, ShowToastOptions };
