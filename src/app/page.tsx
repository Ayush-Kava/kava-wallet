  ...
  const features = [
    {
      ...
      description:
        'Track cash, bank accounts, credit cards, and digital wallets in one place.',
    },
    {
      icon: TrendingUp,
      title: 'Income & Expense Tracking',
      description:
        'Log every transaction with categories for complete visibility.',
    },
    {
      icon: PieChart,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              intuitive money management platform. Simple, secure, and
              completely free.
            </p>
            ...
            {/* Stats */}
            <div
              className="flex flex-wrap justify-center gap-8 lg:gap-16 animate-fade-in"
