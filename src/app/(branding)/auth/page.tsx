...
export default function AuthPage() {
  ...
  const features = [
    {
      ...
      desc: 'Automatic expense categorization',
    },
    {
      icon: Shield,
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left Panel - Branding */}
      <div className="relative hidden overflow-hidden bg-zinc-950 lg:flex lg:w-[45%]">
        <div className="relative z-10 flex flex-col justify-between p-10 text-white">
          <Logo size="lg" variant="onDark" />

          <div className="space-y-8">
            <div>
              <h1 className="mb-3 text-3xl font-semibold tracking-tight xl:text-4xl">
            ...
            <div className="space-y-4">
              {features.map((feature, i) => (
                <div
                  key={i}
                  className="flex items-center gap-4 rounded-xl border border-primary-foreground/10 bg-primary-foreground/5 p-4 backdrop-blur-sm"
